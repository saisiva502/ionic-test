...
var ResDetailPageRoutingModule = /** @class */ (function () {
    function ResDetailPageRoutingModule() {
    }
    ...
    return ResDetailPageRoutingModule;
}());
...
var ResDetailPageModule = /** @class */ (function () {
    function ResDetailPageModule() {
    }
...
var ResDetailPage = /** @class */ (function () {
    function ResDetailPage(http, location, activatedRoute, _resService) {
        this.http = http;
    ...
    ResDetailPage.prototype.ngOnInit = function () {
    };
    ResDetailPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        var x = this.activatedRoute.params.subscribe(function (res) {
            _this.data_type = res.type;
            _this.data_id = res.id;
            // console.log(this.data_id)
        });
        this._resService.resCurrentId(this.data_id, this.data_type).then(function (res) {
            _this.detail_data = res;
            _this.lat = res[0].lat;
            _this.lon = res[0].lon;
            if (_this.lat && _this.lon) {
    ...
    ResDetailPage.prototype.sendNotification = function () {
        var _a, _b, _c, _d;
        var headers = {
        ...
        var jsonToSend = (_a = {},
            _a["app_id"] = "d5e9e3d9-9534-4ad1-bad2-124a65ed3862",
            _a["contents"] = (_b = {}, _b["en"] = "Success fully booked your ground", _b),
            _a["headings"] = (_c = {}, _c["en"] = "All the best", _c),
            _a["subtitle"] = (_d = {}, _d["en"] = "From GrabGrounds", _d),
            // ["buttons"]:[{"id": "id1", "text": "Share", "icon": "ic_menu_share"}, {"id": "id2", "text": "button2", "icon": "ic_menu_send"}],
            _a["big_picture"] = "https://www.myphonemate.com/wp-content/uploads/2019/08/PS-B-PS044.png",
            _a["included_segments"] = ["Active Users", "Inactive Users"],
            _a["isAndroid"] = true,
            _a["isIos"] = true,
            _a);
        this.http.post("https://onesignal.com/api/v1/notifications", jsonToSend, { headers: headers }).subscribe(function (res) {
            console.log(res);
        }, function (err) {
            alert(err);
        });
    ...
    //   alert.present();
    // }
    ResDetailPage.prototype.goBack = function () {
        this.location.back();
    };
    ResDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=res-detail-res-detail-module-es5.js.map